    ...
    <div class='user-background-image'>
        ...
        <div class='container-display-user'>
                ...
                <div class='menu-dashboard-user'>
                    ...
                    <div class='menu-category-size-user'>
                        <a v-show='!isContactVisible' @click='getResultsTickets();searchRequestTickets(),showContact()'><h5>Tickets</h5></a>
                        <a v-show='isContactVisible' @click='hideAll()'><h5>Tickets</h5></a>
                    </div>
                </div>
